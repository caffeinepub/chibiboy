        ...
        <div className="space-y-5 pb-8">
          ...
          >
            ...
            <p className="text-sm text-foreground/80 leading-relaxed">
              ...
              Savings, con domicilio en [indicar domicilio], es responsable del
              tratamiento y protección de los datos personales que recabamos de
              ti, de conformidad con la Ley Federal de Protección de Datos
